...
export default function Hero(){
    ...
    <div className="flex py-10">
     <a className="px-5 hover:text-white" href={config.social.twitter} target="_blank" rel="noreferrer" ><FaSquareXTwitter size={40}/></a>
     <a className="px-5  hover:text-white" href={config.social.linkedin} target="_blank" rel="noreferrer"><FaLinkedin size={40}/></a>
     <a className="px-5   hover:text-white" href={config.social.github} target="_blank" rel="noreferrer"><FaGithub  size={40}/></a>
